...
class _SettingPageState extends State<SettingPage> {
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            readOnly: _classRead,
                            decoration: InputDecoration(
                              hintText: userList.isNotEmpty
                                  ? userList[0].className
                                  : '',
                              enabledBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
                                borderSide:
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      String name = nameController.text.isEmpty
                          ? (userList.isNotEmpty ? userList[0].name : '')
                          : nameController.text;
                      String className = classController.text.isEmpty
                          ? (userList.isNotEmpty ? userList[0].className : '')
                          : classController.text;
                      String imagePath = _image?.path ?? '';

                      updateUser(name, className, imagePath);
  ...
  Future<void> updateUser(
      String name, String className, String imagePath) async {
    await userdb.updateUser(name, className, imagePath);
  }
